                ...
                <Layount className='py-2'>
                    <FrameWhiteBlack
                        ...
                        <div className="flex flex-col w-2/3 p-8">
                            <AnimatedText className='!text-4xl pt-8 text-left z-10 text-light' text={`W naszym salonie zawsze obowiązuje system zbierania punktów rabatowych. Za każdą ósmą usługę otrzymujesz ${0} % zniżki`} />
                        </div>
                    </FrameWhiteBlack>
                    <PriceList />
                </Layount>
