export const priceDataNails = [
  ...
  },
  {
    ...
    name: "Manicure",
    items: [
      { id: 1, name: "Manicure + Odżywka", price: 90 },
      { id: 2, name: "Manicure z Pomalowaniem Zwykły Lakier", price: 110 },
      { id: 3, name: "Peeling Rąk + Masaż", price: 35 },
    ],
  },
  {
    id: 3,
    name: "Manicure Męski",
    items: [{ id: 1, name: "Manicure Męski", price: 90 }],
  },
  {
    id: 4,
