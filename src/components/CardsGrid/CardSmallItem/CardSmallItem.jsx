...
export function CardSmallItem({ description, image, link, icon, title, gradientWord }) {
    ...
    return (
        <div className="flex flex-[50%] items-center justify-center flex-col rounded-3xl flex-nowrap relative overflow-hidden flex-grow bg-cardGrey pb-3 border border-1 border-solid border-borderWhite20">
