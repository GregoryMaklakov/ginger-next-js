...
export function GetDiscountBlock({ wordsVariants1, wordsVariants2, images, scrollYProgress }) {
  ...
  // const borderRadius = useTransform(scrollYProgress, [0, 100], ["0px", "1120rem"])
  // const backgroundColor = useTransform(scrollYProgress, [0, 0.5, .6], ["inherit", "#1b1b1b", "#CC184B"])
  ...
  const gradientVariants02 = {
    animate: {
      background: [
        "linear-gradient(to right, #f8844a, #CC184B))",
        "linear-gradient(to right, #fa75f8, #facc69",
        "linear-gradient(to right, #DC2424, #7053ff)",
        "linear-gradient(to right, #e0658c, #6600ff)",
      ],
      transition: {
        duration: 10,
        repeat: Infinity,
    ...
    <MouseImageTrail renderImageBuffer={50} rotationRange={25} images={images} >
      <motion.div
        ...
        <div className="flex flex-col items-center pt-24 content-center flex-wrap relative justify-center gap-6 xl:gap-3 w-full font-bold capitalize text-left text-8xl 2xl:text-6xl xl:text-4xl text-dark bg-inherit dark:bg-inherit dark:text-light md:text-4xl">
          <div className="flex flex-row gap-6 xl:gap-3 flex-wrap sm:justify-center">
            <h2 className="flex flex-shrink-0">Odkryj</h2>
            <FlippedText textVariants={wordsVariants1} gradientVariants={gradientVariants01} />
            <h2 className="flex flex-shrink-0 2xs:hidden">&</h2>
            <FlippedText textVariants={wordsVariants2} gradientVariants={gradientVariants02} />
          </div>
          <div className="flex flex-row gap-6 xl:gap-3 flex-wrap sm:justify-center">
