...
export function GetDiscountBlock({ wordsVariants1, wordsVariants2, images }) {
  ...
  return (
    <MouseImageTrail renderImageBuffer={50} rotationRange={25} images={images}>
      <div className="pt-0 pb-16 md:pt-16 sm:pt-0 sm:pb-16 z-[999] flex flex-col items-center justify-center relative w-full max-w-[1920px] mx-auto h-full p-32 xl:p-24 lg:p-16 lg:pt-0 md:p-12 sm:p-6 ">
        <StoryLine />
