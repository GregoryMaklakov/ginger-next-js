...
export const BooksyButton = ({ className }) => {
    //animate-spin-slow
    return (
        <div className={`flex items-center justify-center overflow-hidden md:right-0 md:-top-[54px] md:left-auto md:bottom-auto xs:-top-[60px] md:z-50 ${className}`}>
            <div className="w-48 h-auto flex items-center justify-center relative md:w-28">
                <Icon name="circleText" size={220} className="fill-dark dark:fill-light animate-spin-slow" />
                <Link
